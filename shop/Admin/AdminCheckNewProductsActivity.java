     ...
     public void onBlindViewHolder(@NonNull ProductViewHolder holder,int position,@NonNull final Products model)
     {
      ...
      holder.itemView.setOnClickListener(new View.OnClickListener()
      {
          ...
          public void onClick(View view)
          {
              ...
              builder.setTitle("Doriți să aprobați acest produs.Sunteți sigur?");
...
private void ChangeProductState(int protectID)
    {
        ...
        {
            Toast.makeText(AdminCheckNewProductsActivity.this, "Acest produs a fost aprobat și este acum disponibil pentru vânzare de la vânzător. ", Toast.LENGTH_SHORT).show();
        }
    });
    }
}