...
import com.example.shop.Admin.AdminCheckNewProductsActivity;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!type.equals("Admin"))
        {
            userNameTextView.setText(Predominant.currentOnlineUser.getName());
            Picasso.get().load(Predominant.currentOnlineUser.getImage()).placeholder(R.drawable.profile).into(profileImageView);
        }
