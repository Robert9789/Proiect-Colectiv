    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (UserPhoneKey != "" && UserPasswordKey != "")
        {
            if (!TextUtils.isEmpty(UserPhoneKey)  &&  !TextUtils.isEmpty(UserPasswordKey))
            {
                ...
                loadingBar.setMessage("Vă rugăm să așteptați.....");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.child("Users").child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        ...
                        {
                            Toast.makeText(MainActivity.this, "Vă rugăm să așteptați, sunteți deja autentificat....", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(MainActivity.this, "Parola este incorectă.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                else
                {
                    Toast.makeText(MainActivity.this, "Cont cu acest " + phone + "  numărul nu există.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
